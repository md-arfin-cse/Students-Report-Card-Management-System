...
<font color=orange>
       ...
       <b>[ <%if(role.equals("admin")){%><a href="./AdminHome.jsp"><%} else if(role.equals("teacher")){%> <a href="./TeacherHome.jsp?cat=Tester"><%} else if(uname.equals("teacher")){%><a href="./TeacherHome.jsp?cat=Developer&uname=<%=uname%>"><%}else if(uname.equals("HrManager")){%><a href="./HrMangerHome.jsp?cat=HrMangager&uname=<%=uname%>"><%} %><font color="orange">home</font></a> ]</b>&nbsp;
...
<font size="3px">
  ...
  <li><a href="#">Add</a>
  <ul id="nav">
       <li><a href="./AddReportCardDetails.jsp">ReportCardDetails</a></li>
       <li><a href="./AddStudentRemarks.jsp">StudentRemarks</a></li>
  ...
  <li><a href="#">Edit</a>
    <ul>
	   <li><a href="./Recchange_pass1.jsp">Password</a></li>
       <li><a href="./UpdateStudentRemarks.jsp">Student&nbsp;Remarks</a></li>
  ...
  <li><a href="#">View</a>
    <ul>
	   <li><a href="./ViewNotification.jsp">NotificationDetails</a></li>
