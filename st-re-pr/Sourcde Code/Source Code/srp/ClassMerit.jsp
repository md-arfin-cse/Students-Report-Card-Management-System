...
window.location.href="./ClassMerit.jsp?sid="+document.frm.sid.value+"&eid="+document.frm.ename.value+"&subject="+document.frm.subject.value;
...
<br>
<form name="frm" >
<font size="4" >CLASSWISE MERIT</font><br><br>
<table>
